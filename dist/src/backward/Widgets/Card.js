...
Card=function(_NativeBaseComponent){_inherits(Card,_NativeBaseComponent);function Card(){_classCallCheck(this,Card);return _possibleConstructorReturn(this,(Card.__proto__||Object.getPrototypeOf(Card)).apply(this,arguments));}_createClass(Card,[{key:'renderChildren',value:function renderChildren()
...
}}]);return Card;}(_NativeBaseComponent3.default);
