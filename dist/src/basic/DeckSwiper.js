...
_this3.state.pan.setOffset({x:_this3.state.pan.x._value,y:_this3.state.pan.y._value});
...
if(_this3.props.onSwiping){
_this3.props.onSwiping('right',gestureState.dx);
}
}else if(gestureState.dx<-20){
if(_this3.props.onSwiping){
_this3.props.onSwiping('left',gestureState.dx);
}
}
...
if(Math.abs(_this3.state.pan.x._value)>SWIPE_THRESHOLD){
if(velocity>0){
_this3.props.onSwipeRight?_this3.props.onSwipeRight():undefined;
_this3.selectNext();
}else{
_this3.props.onSwipeLeft?_this3.props.onSwipeLeft():undefined;
_this3.selectNext();
}
...
setTimeout(function(){
_this5.setState({
selectedItem:_this5.props.dataSource[nextIndexes[0]]});

setTimeout(function(){
_this5.setState({
selectedItem2:_this5.props.dataSource[nextIndexes[1]]});
