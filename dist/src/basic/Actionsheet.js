...
ActionSheetContainer=function(_Component){_inherits(ActionSheetContainer,_Component);_createClass(ActionSheetContainer,null,[{key:'show',value:function show(
...
}_createClass(ActionSheetContainer,[{key:'componentDidMount',value:function componentDidMount()
{
...
var filtered=options.map(function(item){return item.text;});
...
renderRow:function renderRow(data,i,id){return typeof _this2.state.items[0]==='string'?
...
_react2.default.createElement(_ListItem.ListItem,{onPress:function onPress(){_this2.state.callback(id);_this2.setState({modalVisible:false});},style:{borderColor:'transparent'},icon:true},
...
}}]);return ActionSheetContainer;}(_react.Component);
