...
ToastContainer=function(_Component){_inherits(ToastContainer,_Component);_createClass(ToastContainer,null,[{key:'show',value:function show(_ref)

{var config=_objectWithoutProperties(_ref,[]);
this.toastInstance._root.showToast({config:config});
}}]);
...
}_createClass(ToastContainer,[{key:'componentDidMount',value:function componentDidMount()
{
if(!this.props.autoHide&&this.props.duration){
console.warn('It\'s not recommended to set autoHide false with duration');
}
}},{key:'showToast',value:function showToast(_ref2)
{var _this2=this;var config=_ref2.config;
this.setState({
modalVisible:true,
text:config.text,
...
}}]);return ToastContainer;}(_react.Component);
